...
public class GetProductInfoFromMySQLCommand extends HystrixCommand<ProductInfo> {
    ...
    protected ProductInfo run() throws Exception {
        ...
        String json = "{\"id\": " + productId + ", \"name\": \"iphone7手机\", \"price\": 59, \"pictureList\":\"a.jpg,b.jpg\", \"specification\": \"iphone7的规格\", \"service\": \"iphone7的售后服务\", \"color\": \"红色,白色,黑色\", \"size\": \"5.5\", \"modifiedTime\": \"2017-01-01 12:00:00\"}";
