 ...
 */
public class GetProductInfoCommand4 extends HystrixCommand<ProductInfo> {

    public static final HystrixCommandKey KEY = HystrixCommandKey.Factory.asKey("GetProductInfoCommand");

    private Long productId;

    public GetProductInfoCommand4(Long productId) {
    ...
    protected ProductInfo run() throws Exception {
        ...
        System.out.println("GetProductInfoCommand4");
    ...
    protected ProductInfo getFallback() {
        System.out.println("GetProductInfoCommand4 降级商品");
